        ...
        <div {...animatedItem} className="content move">
            ...
            <div className="info">
                <div className='boxWrap'>
                    <div className='box'>
                        <img src={married}></img>
                        <div>보조대기실<span>(2층)</span></div>
                    </div>
                    <div className='box'>
                    <img src={bride}></img>
                        <div>신부대기실<span>(5층)</span></div>
                    </div>
                    <div className='box'>
                        <div>icon</div>
                        <div>연회장<span>(4층)</span></div>
                    </div>
                ...
                <div className='boxWrap'>
                    ...
                    <img src={married}></img>
                        <div>2부 시작<span>(1층)</span></div>
                    </div>
                    <div className='box'>
                    <div className='time'>14:00</div>
                        <div>연회장<span>(1층)</span></div>
                        <div>icon</div></div>
                    <div className='box'>
                    <div className='time'>13:30</div>
                        <img src={married}></img>
                        <div>예식 시작<span>(5층)</span></div>
                        </div>
                    <div className='box last'></div>
                </div>
            </div>
